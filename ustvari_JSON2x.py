...
with open(r'C:\Users\Jure Selšek\Documents\VSŠ FE\3.LETNIK\1. semester\TP x\github\DN3\zacetniData.json', 'w') as f:
    json.dump(zacetniData, f, indent=2)

with open(r'C:\Users\Jure Selšek\Documents\VSŠ FE\3.LETNIK\1. semester\TP x\github\DN3\updateData.json', 'w') as f:
